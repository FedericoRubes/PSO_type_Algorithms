...
% TUTTI TUTTI TUTTI
% Fare dopo aver lanciato FAAckleyNNISN
figure
semilogy(t,decti,t,decn1,t,decsn,t,dec1,'b',t,dec2,'r',t,dec3,'g','linewidth',2.5)
title("Function Value",'FontSize',18)
xlabel('Iterations','FontSize',12)
legend("Total Interaction","Nanbu I","Symmetric Nanbu","Firefly Algorithm","FA with Nanbu I","FA with SN")
